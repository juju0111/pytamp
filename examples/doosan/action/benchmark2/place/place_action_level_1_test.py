...
benchmark2 = Benchmark2(
    robot_name="doosan", geom="visual", is_pyplot=False, bottle_num=1
)
pick = PickAction(
    benchmark2.scene_mngr, n_contacts=0, n_directions=3, retreat_distance=0.1
)
place = PlaceAction(
