...
parser = argparse.ArgumentParser(description="Test Benchmark rearr 1.")
...
# sys.path.append(os.path.join(home_path, "acronym"))
# sys.path.append(os.path.join(home_path, "contact_graspnet"))
...
directory_name = pytamp_path + "/results" + "/benchmark1" + "/benchmark1_rearr_result"
